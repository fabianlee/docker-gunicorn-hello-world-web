...
k8s-apply:
	VERSION=$(VERSION) NEW_RELIC_APP_NAME=k8s-gunicorn-hello-world-web NEW_RELIC_LICENSE_KEY=$(NEW_RELIC_LICENSE_KEY) envsubst < gunicorn-hello-world-web.yaml | kubectl apply -f -
